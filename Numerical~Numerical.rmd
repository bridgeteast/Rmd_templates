...
###Code below can be run as a chunk to ge interactivity -- so far can't get knitted version to work  
  
```{r}
plot3d(davisdata$Height,davisdata$dadheight,davisdata$momheight,type="s",size=1,lt=TRUE)
```
